...
@Entity
@Table(
    name = "store_provisioning_part2_requests",
    indexes = @Index(name = "idx_store_part2_request_store", columnList = "organization_id,store_id,created_at")
)
public class StoreProvisioningPart2RequestEntity {
