...
@Entity
@Table(
    name = "store_readiness_evidence",
    indexes = @Index(name = "idx_store_readiness_evidence_scope", columnList = "organization_id,store_id,status")
)
public class StoreReadinessEvidenceEntity {
