...
grep -Fq 'organization_claim_db_authority=PASS' "$SMOKE"
! grep -Fq 'wrong_organization_real_store=PASS' "$SMOKE"
grep -Fq 'inconsistent_organization_claim_api.request(f"/api/v1/stores/{store_id + 1000000}/context", expected=403)' "$SMOKE"
