...
printf '    APP_PHASE_B_RUNTIME: "%s"\n' "$(value STAGING_PHASE_B_RUNTIME)"
...
STAGING_PHASE_B_RUNTIME=staging
...
for key in \
  ...
  APP_FEATURES_PLATFORM APP_PHASE_B_PROVISIONING_ENABLED APP_PHASE_B_RUNTIME \
