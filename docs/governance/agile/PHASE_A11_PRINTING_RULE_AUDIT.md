...
Current stop after repository implementation candidate:
...
- `docs/architecture/current-staging/05_PRINTING_SEQUENCE.md`
...
- `docs/governance/agile/AL-004_GENERIC_STORE_PROFILE_CONTRACT.md`
- `docs/governance/agile/AL-005_PRINTING_PROVISIONING_MODULE_PLAN.md`
- `docs/governance/agile/AL-005B_DEVICE_PAD_PROVISIONING_MODULE_PLAN.md`
