...
| PB2-PROVISION | FEATURE | OWNER_AUTHORIZED_IMPLEMENTATION | P2 | Phase B Part 2 | No | Complete tables/stations, staff/access, printing topology, device enrollment, validation, READY and activation workflow inside the current roadmap candidate scope; real Store activation and physical bindings remain Owner gates. | [`CURRENT_STATE.yml`](CURRENT_STATE.yml), [`ROADMAP.md`](ROADMAP.md), [`drafts/`](drafts/) |
