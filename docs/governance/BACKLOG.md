...
| --- | --- | --- | --- | --- | --- | --- | --- |
| MENU-SIMPLIFY | FEATURE | IN_PROGRESS | P1 | Phase B / Menu Management | Yes | Explicit Combo egg exceptions, Store Add-on catalog, ADD_ON code immutability, item eligibility and code-based printing alignment. Production business-value reconciliation remains Owner-gated. | [contract](contracts/MENU_ADDON_CATALOG_CONTRACT.md), [state](CURRENT_STATE.yml) |
