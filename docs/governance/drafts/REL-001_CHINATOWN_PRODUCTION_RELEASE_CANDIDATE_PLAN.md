...
>
> Canonical release policy: [Repository Authority and Workflow](../AUTHORITY.md#9-production-policy).
...
> Production St-Denis inventory is now recorded in [the parity manifest](../../archive/governance-pre-simplification/runtime/ST_DENIS_TWIN_PARITY_MANIFEST.md)
> and [its evidence report](../../archive/governance-pre-simplification/runtime/TWIN-001_PRODUCTION_INVENTORY_EVIDENCE.md).
