...
> [FINAL_PRODUCTIZATION_PLANBOOK](../../archive/governance-pre-simplification/agile/FINAL_PRODUCTIZATION_PLANBOOK.md). Phase A is
...
the current [Repository Authority and Workflow](../AUTHORITY.md#9-production-policy).
