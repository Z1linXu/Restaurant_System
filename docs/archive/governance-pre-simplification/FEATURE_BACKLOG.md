...
> **SUPERSEDED / HISTORICAL ONLY.** Active work is tracked only in
...
4. `AL-005A_STAFF_TABLE_PROVISIONING_MODULES`: reusable staff/access and table
   ...
   [AL-005A Staff and Table Provisioning Module Plan](../../governance/drafts/AL-005A_STAFF_TABLE_PROVISIONING_MODULE_PLAN.md).
5. `AL-005_PRINTING_PROVISIONING_TEMPLATE`: Store-scoped printer/module
   ...
   preparation is [AL-005 Printing Provisioning Module Plan](../../governance/drafts/AL-005_PRINTING_PROVISIONING_MODULE_PLAN.md).
6. `AL-005B_DEVICE_PAD_PROVISIONING_MODULE`: reusable Store device binding and
   ...
   bounded preparation is [AL-005B Device and Pad Provisioning Module Plan](../../governance/drafts/AL-005B_DEVICE_PAD_PROVISIONING_MODULE_PLAN.md).
