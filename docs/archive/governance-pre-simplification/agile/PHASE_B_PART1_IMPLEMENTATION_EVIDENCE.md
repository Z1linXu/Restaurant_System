...
Auth-prefix repair deploy/runtime evidence:

```text
auth_prefix_repair_merge_sha = 6fff80e81651727f27f5b999c2e9c5c438fd7f31
staging_health = PASS
staging_readiness = PASS
staging_flyway = V20
acceptance_validate = PASS
acceptance_r2 = BLOCKED_BEFORE_STORE_CREATION
